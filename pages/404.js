...
export default function Error404() {
  return (
    <>
      ...
      >
        <section className="md:min-h-3/5">
          <h1>404: Whoops!</h1>
          <h2 className="mt-8">Looks like that page no longer exists</h2>
          <p>
            Or it could have never existed in the first place. Come to think of
            it, maybe none of this actually exists? This could all be a really
            complex computer simulation, or something... 🤔
          </p>
          <p>
