    ...
    <>
      <Layout>
        <section className="animate-fade-in flex flex-col justify-center min-h-screen md:min-h-3/4">
          ...
          <p className="animate-fade-in fade-lg">A <a href="https://github.com/maxpetretta">software engineer</a> with a passion for building intuitive applications, reliable services, and systems that scale.  Currently, I'm building the future of cloud infrastructure at <a href="https://www.gehealthcare.com/">GE Healthcare</a>.</p>
          <ul className="animate-fade-in fade-lg">
            <li>
              <svg xmlns="http://www.w3.org/2000/svg" className="inline mr-2 md:mr-3 w-7 h-7 md:w-10 md:h-10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
            ...
            <li>
              ...
              <span className="align-middle">Proud University of Michigan alumni</span>
            </li>
            <li>
              <svg xmlns="http://www.w3.org/2000/svg" className="inline mr-2 md:mr-3 w-7 h-7 md:w-10 md:h-10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
              ...
              <span className="align-middle">Over 4 years of work experience</span>
            </li>
          </ul>
          ...
          <span className="animate-fade-in fade-lg mx-auto mt-10">
            <svg xmlns="http://www.w3.org/2000/svg" className="animate-bounce w-14 h-14" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">            
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
