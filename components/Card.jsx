...
export default function Card({ post }) {
  return (
    <Link href={"/blog/" + post.slug}>
      <a className="flex flex-wrap transform transition duration-300 w-full font-normal m-3 p-3 rounded-xl shadow-lg bg-gray-50 hover:scale-105 hover:text-black hover:bg-white dark:bg-gray-800 dark:hover:text-gray-100 dark:hover:bg-gray-700">
