  ...
  return (
    <footer className="flex flex-col items-center pt-4">
      <address className="flex justify-center">
        <a className="btn hover:text-gray-100 hover:bg-black dark:hover:text-black dark:hover:bg-gray-100" href="https://github.com/maxpetretta">
        ...
        <a className="btn hover:text-gray-100 hover:bg-blue-400 dark:hover:text-white dark:hover:bg-blue-400" href="https://twitter.com/maxpetretta">
        ...
        <a className="btn hover:text-gray-100 hover:bg-blue-800 dark:hover:text-white dark:hover:bg-blue-800" href="https://www.linkedin.com/in/maxpetretta/">
