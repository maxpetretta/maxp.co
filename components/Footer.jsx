  ...
  return (
    <footer className="flex flex-col items-center py-6">
      <address className="flex justify-center">
        <a className="rounded-xl p-3 mx-2 transition duration-300 hover:bg-gray-300" href="https://twitter.com/maxpetretta">
        ...
        <a className="rounded-xl p-3 mx-2 transition duration-300 hover:bg-gray-300" href="https://github.com/maxpetretta">
        ...
        <a className="rounded-xl p-3 mx-2 transition duration-300 hover:bg-gray-300" href="https://www.linkedin.com/in/maxpetretta/">
        ...
        <a className="rounded-xl p-3 mx-2 transition duration-300 hover:bg-gray-300" href="mailto:max.petretta@gmail.com">
      ...
      <p className="text-gray-400 text-sm">&copy; 2020 - {new Date().getFullYear()} Max Petretta</p>
    </footer>
  )
}
