...
export default function Footer() {
  return (
    <footer className="flex flex-col items-center my-6">
      <address className="flex justify-center">
        <a className="rounded-xl p-3 mx-2 hover:bg-gray-300" href="https://twitter.com/maxpetretta">
        ...
        <a className="rounded-xl p-3 mx-2 hover:bg-gray-300" href="https://github.com/maxpetretta">
        ...
        <a className="rounded-xl p-3 mx-2 hover:bg-gray-300" href="https://www.linkedin.com/in/maxpetretta/">
        ...
        <a className="rounded-xl p-3 mx-2 hover:bg-gray-300" href="mailto:max.petretta@gmail.com">
