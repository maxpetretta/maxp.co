  ...
  return (
    <footer className="flex flex-col items-center pt-4">
      <address className="flex justify-center">
        <a className="btn hover:text-gray-100 hover:bg-black" href="https://github.com/maxpetretta">
        ...
        <a className="btn hover:text-gray-100 hover:bg-blue-400" href="https://twitter.com/maxpetretta">
        ...
        <a className="btn hover:text-gray-100 hover:bg-blue-900" href="https://www.linkedin.com/in/maxpetretta/">
