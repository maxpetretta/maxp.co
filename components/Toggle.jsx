export default function Toggle({id, alt, onClick}) {
  return (
    <label className="inline-flex flex-shrink-0 align-middle w-10 h-6 xs:w-12 xs:h-7 ml-2 md:ml-5 rounded-full shadow-inner cursor-pointer bg-gray-400 dark:bg-gray-500" alt={alt}>
