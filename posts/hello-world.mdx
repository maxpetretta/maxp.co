...
import banner from "../public/images/wave.png"
...
Hello, and thanks again for visiting my blog. As we get started, I just wanted to establish some ground rules...

## Who am I?

Not trying to be philosophical or anything, but identity is complicated. It's always felt weird to me that (as Americans), the go-to introduction is "I'm an X role at Y company".
...
At this point, I've been online for most of my life. I've spent most of that time as a [lurker](https://en.wikipedia.org/wiki/Lurker), passively consuming the content of others, but never really creating my own. This is a common phenonenom, so much so that it has been decribed as the ["1% rule of the internet"](<https://en.wikipedia.org/wiki/1%25_rule_(Internet_culture)>); only a small handful of users create the posts that the rest of us enjoy on a daily basis.

I've been aware of this quality in myself for quite some time. In fact, I built this blog over a year ago, at the end of 2020. But it's sat empty all this time. I think much of that stems from my crippling fear of [being wrong on the internet](https://xkcd.com/386/).

### That was pretty silly, on my part.

Of course I will make mistakes, that's only natural! It's also doing myself a disservice, as the potential to learn and improve is much greater when you let the world "check your math". This idea is known as ["Learn in Public"](https://www.swyx.io/learn-in-public/), popularized by [@swyx](https://twitter.com/swyx).
...
- How I built this blog w/ Next.js
- Why I use a split, mechanical keyboard
- A review of Apple's AirPods Max
...
Writing is one of the habits I've decided to focus on. So cheers to 2022, let's see where we end up.
